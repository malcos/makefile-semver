...
runtests:
	...
	$(DO) execute ACTION="version.nextcycle" verify EXPECTED="1.2.3-betatest.2"
	$(DO) execute ACTION="version.nextcycle" verify EXPECTED="1.2.3-betatest.3"
	$(DO) execute ACTION="version.nextcycle" verify EXPECTED="1.2.3-betatest.4"
	$(DO) execute ACTION="version.nextcycle" verify EXPECTED="1.2.3-betatest.5"
	$(DO) execute ACTION="version.nextcycle" verify EXPECTED="1.2.3-betatest.6"
	$(DO) execute ACTION="version.nextcycle" verify EXPECTED="1.2.3-betatest.7"
	$(DO) execute ACTION="version.nextcycle" verify EXPECTED="1.2.3-betatest.8"
	$(DO) execute ACTION="version.nextcycle" verify EXPECTED="1.2.3-betatest.9"
	$(DO) execute ACTION="version.nextcycle" verify EXPECTED="1.2.3-betatest.10"
	$(DO) execute ACTION="version.nextcycle" verify EXPECTED="1.2.3-betatest.11"
	$(DO) setup VALUE="1.2.3-betatest.19" execute ACTION="version.nextcycle" verify EXPECTED="1.2.3-betatest.20"
	$(DO) setup VALUE="1.2.3-betatest.99" execute ACTION="version.nextcycle" verify EXPECTED="1.2.3-betatest.100"
	$(DO) setup VALUE="1.2.3-betatest.999" execute ACTION="version.nextcycle" verify EXPECTED="1.2.3-betatest.1000"
	$(DO) setup VALUE="1.2.3-betatest.9999" execute ACTION="version.nextcycle" verify EXPECTED="1.2.3-betatest.10000"
	$(DO) setup VALUE="1.2.3-betatest.99999" execute ACTION="version.nextcycle" verify EXPECTED="1.2.3-betatest.100000"
	$(DO) setup VALUE="1.2.3-betatest.100000" execute ACTION="version.nextcycle" verify EXPECTED="1.2.3-betatest.100001"

	$(DO) header TEXT="version.nextcycle is idempotent when cycle name is not defined"
	$(DO) setup VALUE="" execute ACTION="version.nextcycle" verify EXPECTED="0.0.0"
	$(DO) setup VALUE="3.14.15" execute ACTION="version.nextcycle" verify EXPECTED="3.14.15"
